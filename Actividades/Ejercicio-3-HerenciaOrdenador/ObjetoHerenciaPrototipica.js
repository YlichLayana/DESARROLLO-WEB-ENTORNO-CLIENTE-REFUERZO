//Todo: Variables que usare para captura de datos en el formulario
var radioButton, marca, modelo, ram, hd, pantalla;
//var ordenadores = [];

//Otro: Variables que usare para obtener el valor por defecto dado en los placeholder
var ramDefault;
var hdDefault;
var pantallaDefault;
var autonomiaDefault;

var tipoLapto=false; //* esta variable la usare para condicionar si es un objeto padre o hijo
      

document.addEventListener('DOMContentLoaded', inicializa, false);

//! Funcion que se llama al momento de la carga de la pagina en la cual preparo todos los elemento del html
function inicializa(){

  //elemento radio
  radioButton=document.getElementsByName('tipo');

  //Todo: elementos input listos para usarlos 
  ...
  //otro: capturo el valor por default que tiene el formulario en place holder
  ...
  if (event.target.type =="radio" ){
    ...
    if(radioButton[1].checked==true){
      ...
      function agregando(event){
        //Todo: variables con los que capturo lo datos pasados a los input
        ...
        //otro: aqui realizo la condición de que si mi evento es disparado por un click realizado al type submit o type button y si los dos primeros input de marca y modelo no estan vacios 
      ...
      function Ordenador(marca, modelo, ram, hd, pantalla){
        ...
        //TODO: el metodo listado lo colocare fuera del contrustor para que ocupe menos espacio de memoria al momento de instanciar nuevos objetos, para ello le vamos asignar al prototipo de la funcion constructora Ordenador el metodo listado 
      ...
      //*metodo agregado al prototipo de la funcion constructora padre
      Ordenador.prototype.listado = function(){
        console.log('DATOS ORDENADOR\n Marca: '+ this.marca + '\n Modelo: '+ this.modelo + '\n RAM: '+ this.ram + '\n HD: '+ this.hd +'\n PANTALLA: ' +this.pantalla);
      ...
      //!funcion constructora hija 
        function OrdenadorPortatil(marca, modelo, ram, hd, pantalla, autonomia){
          this.super=Ordenador;
          this.super(marca, modelo, ram, hd, pantalla);
          this.autonomia = autonomia || autonomiaDefault;
        }

        //TODO: OrdenadorPortatil está heredando de Ordenador
        //TODO: Aqui el prototipo de OrdenadorPortatil es una instancia de Ordenador 
        OrdenadorPortatil.prototype=new Ordenador();
        //OTRO: Y aqui le creamos su propio constructor 
        OrdenadorPortatil.prototype.constructor =OrdenadorPortatil

        //OTRO: aqui realizo la sobreescritura del metodo del prototipo padre
        OrdenadorPortatil.prototype.listado= function(){
        ...
        OrdenadorPortatil.prototype.probar=function(){
